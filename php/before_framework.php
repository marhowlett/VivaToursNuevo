	...
	function boldthemes_set_override() {
		...
		if ( ! is_404() ) {
			...
			if ( is_post_type_archive( 'tour' ) ) {                            
                                if ( !is_null( boldthemes_get_id_by_slug($boldthemes_options['tour_slug']) ) && boldthemes_get_id_by_slug($boldthemes_options['tour_slug']) != '' ) {
					$tmp_boldthemes_page_options1 = boldthemes_rwmb_meta( BoldThemesFramework::$pfx . '_override', array(), boldthemes_get_id_by_slug($boldthemes_options['tour_slug']) );
				} else  if ( !is_null( boldthemes_get_id_by_slug('tour') ) && boldthemes_get_id_by_slug('tour') != '' ) {
				...
				<label>
					<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
                                        <?php if ( $this->description != '' ) { ?>
                                            <span id="customize-media-control-description-<?php echo esc_attr( $this->priority ); ?>" class="description customize-control-description"><?php echo esc_html( $this->description ); ?></span>
                                        <?php } ?>
