...
function bt_register_meta_boxes( $meta_boxes ) {
    ...
    $meta_boxes[] = array(
        ...
        'title'      =>  __('Comienzo del tour', 'bt_plugin'),
        'post_types' => 'tour',
        'context'    => 'normal',
        'priority'   => 'high',
        'fields' => array(
            array(
                'id'         => 'tour_dt',
                'name'       => __('Comienzo del tour', 'bt_plugin'),
                'label_description' => __('Ingresa la duración del tour ejemplo: Comienza el tour el: X de Mes', 'bt_plugin'),
                'type'       => 'text',
                'clone'      => false,               
                'inline'     => false,
                'timestamp'  => false,
